...
def main(args):
    ...
    if args.mask_init == "orc":  # just set the mask
        # trigger_h, trigger_w, trigger_r = 22, 22, 9 #author_to_do to be deleted; for optimize green/purple
    ...
    for e in range(epochs):
        ...
        if res_best["mask"] != None and res_best["patch"] != None:
            ...
            dir = f"trigger_inv_{args.timestamp}/{args.encoder_usage_info}_{succ_threshold}_{lambda_min}_{args.seed}_{args.model_flag}_{args.batch_size}_{args.lr}_{args.mask_init}{args.id}"
